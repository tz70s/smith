...
actor_expression_list : actor_expression terminator
                      | actor_expression_list actor_expression terminator
                      | terminator
                      ;

actor_expression : function_definition
                 | function_inline_call
                 | behavior_definition 
                 | if_statement
                 | rvalue
...
import_block : IMPORT literal_t;

actor_definition : actor_definition_header actor_definition_body END;

actor_definition_header : ACTOR id;

actor_definition_body : actor_expression_list;

behavior_definition : behavior_definition_header behavior_definition_body END;

behavior_definition_header : BEHAVIOR function_name crlf
                           | BEHAVIOR function_name function_definition_params crlf
                           ;

behavior_definition_body : actor_expression_list;

function_definition : function_definition_header function_definition_body END;

function_definition_body : expression_list;

function_definition_header : FUN function_name crlf
                           | FUN function_name function_definition_params crlf
                           ;
...
if_elsif_statement : ELSIF cond_expression crlf statement_body END
                   | ELSIF cond_expression crlf statement_body else_token crlf statement_body END
                   | ELSIF cond_expression crlf statement_body if_elsif_statement END
                   ;
